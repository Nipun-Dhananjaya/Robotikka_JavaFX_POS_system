...
public class ProductDetail implements SuperEntity{
    ...
    public ProductDetail(String code, String barcode, int qtyOnHand, double sellingPrice, boolean discountAvailability, double showPrice, int productCode, double buyingPrice) {
        this.code = code;
