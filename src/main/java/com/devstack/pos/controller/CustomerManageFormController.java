...
import com.devstack.pos.tm.CustomerTm;
...
public class CustomerManageFormController {
    ...
    public JFXButton btnManageLoyaltyCards;
    public JFXButton btnNewCust;
    public JFXTextField txtEmail;
    public JFXTextField txtName;
    public JFXTextField txtContact;
    public JFXTextField txtSalary;
    public JFXButton btnSaveCust;
    ...
    public void initialize() throws SQLException, ClassNotFoundException {
        ...
        tblCust.getSelectionModel().selectedItemProperty()
    ...
    private void setData(CustomerTm newValue) {
        ...
        btnSaveCust.setText("Update Customer");
    ...
    private void loadAllCustomers(String searchText) throws SQLException, ClassNotFoundException {
        ...
        int counter=1;
        for (CustomerDto dto:
                searchText.length()>0?bo.searchCustomer(searchText):bo.findAllCustomers()) {
        ...
        tblCust.setItems(observableList);
    }
    ...
    public void btnNewCustOnAction(ActionEvent actionEvent) {
        txtEmail.setEditable(true);
        btnSaveCust.setText("Save Customer");
        clearFields();
    }

    public void btnSaveCustOnAction(ActionEvent actionEvent) {
        try {
            if (btnSaveCust.getText().equals("Save Customer")){
                if(bo.saveCustomer(
                        new CustomerDto(txtEmail.getText(),txtName.getText(),txtContact.getText(),
